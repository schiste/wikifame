...
WikiFame powers a French Wikipedia personal-script prototype that displays three registered,
non-bot, non-temporary accounts associated with surviving WikiWho tokens and links the remaining
historical contributor count to page history. Toolforge is the prototype backend.
